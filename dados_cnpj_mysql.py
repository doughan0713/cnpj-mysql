...
if tipo_banco == 'mysql':
    ...
    print(f'Tipo de banco de dados "{tipo_banco}" não suportado.')
    sys.exit()
...
# Dask e Pandas preferem o objeto engine ou a string de conexão.
# Usamos o objeto engine_ para maior compatibilidade.
engine_url = engine_
...
engine.execute(text("insert into _referencia (referencia, valor) values ('CNPJ', :valor)"), {"valor": dataReferencia})
