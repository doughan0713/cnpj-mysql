...
# Secure parameterized queries with SQLAlchemy text() to prevent SQL Injection
engine.execute(text("insert into _referencia (referencia, valor) values (:ref, :val)"), {"ref": "CNPJ", "val": str(dataReferencia)})
