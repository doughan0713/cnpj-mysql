...
# ✅ GOOD: Parameterized queries used instead of f-string SQL interpolation.
# This prevents SQL Injection vulnerability by separating SQL query logic from user/system data.
