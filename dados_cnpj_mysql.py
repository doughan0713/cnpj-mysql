...
if tipo_banco == 'mysql':
    ...
    print('tipo de banco de dados não suportado:', tipo_banco)
    sys.exit()

db_port = int(port) if port and port.isdigit() else default_port
...
# Proteção contra SQL Injection usando parâmetros nomeados
engine.execute(
