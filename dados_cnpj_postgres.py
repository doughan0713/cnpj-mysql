...
# Security fix: Use parameterized queries to prevent SQL injection in metadata table
engine.execute(text("insert into _referencia (referencia, valor) values ('CNPJ', :data_ref)"), {"data_ref": dataReferencia})
