...
engine.execute(text("insert into _referencia (referencia, valor) values ('CNPJ', :data)"), {"data": dataReferencia})
engine.execute(text("insert into _referencia (referencia, valor) values ('cnpj_qtde', :qtde)"), {"qtde": qtde_cnpjs})
